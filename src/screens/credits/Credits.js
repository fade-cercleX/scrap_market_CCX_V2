    ...
    <View style={style.screen}>
      ...
      <View style={{...styles.freeCreditBox}}>
        <View>
          ...
          <View style={{...style.row ,...style.s_b,...style.mv_1}}><Text>5 Scraps</Text><Text>1 coin </Text></View>
          <View style={{...style.row ,...style.s_b} }><Text>25 Scraps</Text><Text>1 contact detail</Text></View>
        </View>
      </View>
      <View style={style.mv_2} >
        ...
        <SecondaryButton onPress={()=> navigate.navigate('PurchaseCredits') } >Buy Additional Credits</SecondaryButton>
    </View>
    </ScrollView>
  );
};
