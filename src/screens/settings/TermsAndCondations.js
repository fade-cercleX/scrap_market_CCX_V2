    ...
    <SafeAreaView>
      <ScrollView showsVerticalScrollIndicator={false} >
        ...
        <Text style={styles.descriptions}>
          This mobile app is operated by Infinite Cercle Private Limited (Cercle
          X). ThinkTrash is a brand owned by Cercle X. Throughout the site, the
          terms “we”, “us” and “our” refer to Cercle X. Cercle X offers this
        ...
        <Text style={styles.title}>SECTION 1 – ONLINE STORE TERMS</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.title}>SECTION 2 – GENERAL CONDITIONS</Text>
        ...
        <Text style={styles.title}>SECTION 5 – PRODUCTS OR SERVICES</Text>
        ...
        <Text style={styles.title}>SECTION 7 – OPTIONAL TOOLS</Text>
        ...
        <Text style={styles.title}>SECTION 8 – THIRD-PARTY LINKS</Text>
        <Text style={styles.descriptions}>
          Certain content, products and services available via our Service may
          include materials from third-parties. Third-party links on this site
          may direct you to third-party websites that are not affiliated with
        ...
        <Text style={styles.title}>SECTION 10 – PERSONAL INFORMATION</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.title}>SECTION 12 – PROHIBITED USES</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.descriptions}>
          ...
          non-infringement. In no case shall Indian Superheroes, our directors,
        ...
        <Text style={styles.title}>SECTION 14 – INDEMNIFICATION</Text>
        <Text style={styles.descriptions}>
          You agree to indemnify, defend and hold harmless Indian Superheroes
          ...
          violation of any law dor the rights of a third-party.
        </Text>

        <Text style={styles.title}>SECTION 15 – SEVERABILITY</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.title}>SECTION 16 – TERMINATION</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.title}>SECTION 17 – ENTIRE AGREEMENT</Text>
        <Text style={styles.descriptions}>
        ...
        <Text style={styles.title}>SECTION 18 – GOVERNING LAW</Text>
        <Text style={styles.descriptions}>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of India and jurisdiction of Coimbatore, India.
        </Text>
        ...
        <Text>SECTION 20 – CONTACT INFORMATION</Text>
        <Text style={styles.descriptions}>
          Questions about the Terms of Service should be sent to us at
          support@cerclesolutions.com.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
