...
const PrivacyPolicies = () => {
  return (
    ...
    <View  style={styles.screen} >
      <Image source={require('../../../assets/images/privacyPolicies.png')} style={styles.image} />
      <View>
        ...
        <View>
          ...
          <Text style={styles.descriptions}>How do you get my consent?</Text>
          <Text style={styles.descriptions}>
          ...
          <Text style={styles.descriptions}>How do I withdraw my consent?</Text>
          <Text style={styles.descriptions}>
        ...
        <View>
          ...
          <Text style={styles.descriptions}>
            We use Razorpay/CCAvenue for processing payments.
            We/Razorpay/CCAvenue do not store your card data on their servers.
            The data is encrypted through the Payment Card Industry Data
            Security Standard (PCI-DSS) when processing payment. Your purchase
            transaction data is only used as long as is necessary to complete
        ...
        <View>
          <Text style={styles.title}> AGE OF CONSENT</Text>
          <Text style={styles.descriptions}>
        ...
        <View>
          <Text style={styles.title}>QUESTIONS AND CONTACT INFORMATION</Text>
          <Text style={styles.descriptions}>
            ...
            <TouchableWithoutFeedback
              onPress={() => {
                Linking.openURL("https://cerclex.com/");
              }}
            >
              <View style={styles.link}>
                <Text style={{ color: "#6F2DA8" }}>
                  support@cerclesolutions.com
                </Text>
              </View>
            </TouchableWithoutFeedback>
